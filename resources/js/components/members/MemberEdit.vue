            ...
            <div>
                ...
                <div class="p-fluid p-formgrid p-grid mt-5">
                    ...
                    <div class="p-field p-col">
                        ...
                        <Password v-model="form.password"  toggleMask id="password" name="password"  placeholder="Password"  />
                    </div>
                    <div class="p-field p-col">
                        <label for="surname" class="p-sr-only">ConfirmPassword</label>
                        <Password v-model="form.confirmPassword" toggleMask id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" />
                    </div>
...
export default {
    ...
    methods: {
        ...
        save(){
            ...
            if((this.form.password == '' && this.form.confirmPassword == null) || (this.form.password == null && this.form.confirmPassword == '')){
                this.confirmPasswordStatus = true;
            }
    
            if(this.confirmPasswordStatus){
                axios.put('/members/update/' + this.member.id, this.form)
                .then(response => {
