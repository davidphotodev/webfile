<template>
  <div>
    <div class="container h-center">
        <div class="m-5 p-5 border border-5 shadow white col-md-12">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Instrumentos</a>
            </li>
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div>
                        <div class="container">
                            <div class="text-center">
                                <h2 class="mt-5">Detalle Residente</h2>
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="col-md-12">
                        <div class="container">
                            <div class="text-center">
                                <h2 class="mt-5" v-if="instrumentos.length > 0">Instrumentos del Residente</h2>
                            </div>
                        </div>

                            <div class="my-5 mx-2 d-flex justify-content-between" v-if="instrumentos.length > 0">
                                <h4>Instrumentos Aplicados</h4>
                            </div>
                            <div  class="my-5 mx-5 d-flex justify-content-center"  v-else>
                                <h4>Este Residente no tiene Instrumentos Aplicados</h4>
                            </div>
                            <table class="table" v-if="instrumentos.length > 0">
                            <thead>
                                <tr>
                                <th scope="col">#</th>
                            ...
                            <tbody>
                                <tr v-for="(item, i) in instrumentos" :key="item.id">
                                <th scope="row">{{ i + 1 }}</th>
                                <td>{{ item.title }}</td>
                                <th scope="row">{{ item.rol }}</th>
                                <td>
                                    <a class="btn btn-primary btn-sm text-light mr-5" @click="ver(item.id, 1)">
                                        Ver
                                    </a>
                                    <a
...
export default {
    ...
    props: ['resident', 'instrumentos', 'rol'],
    components: {
        Field,
    },
    data(){
    ...
    methods:{
        ver(id){
            window.open("/instruments/ver/"+id+"/"+ 2, '_blank');
        },
